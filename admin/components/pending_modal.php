...
<!-- viewapprove -->
<div class="modal fade" id="p_approve">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
              ...
              <form class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="approve_request" class="col-sm-3 control-label">Request Note</label>
                    <div class="col-sm-7">
                      <textarea name="approve_request" id="approve_request" class="form-control" rows="4" disabled></textarea>
                    </div>
                </div>
<hr>
                <div class="form-group">
                    <label for="view_approve" class="col-sm-3 control-label">Approval Note</label>
                    <div class="col-sm-7">
...
<!-- viewdecline -->
<div class="modal fade" id="p_decline">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
              <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            ...
            <div class="modal-body">
              ...
              <form class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="decline_request" class="col-sm-3 control-label">Request Note</label>
                    <div class="col-sm-7">
                      <textarea name="decline_request" id="decline_request" class="form-control" rows="4" disabled></textarea>
                    </div>
                </div>
<hr>
                <div class="form-group">
