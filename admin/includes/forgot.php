   ...
   if($query->num_rows < 1){
    $_SESSION['email_error'] = 'Email Does Not Exist in the Database.';
     ...
     if ($conn->query($sql_insert)) {
      ...
      $output.='<p><a href="http://localhost/LNUstudentdorm/admin/pages/reset-password.php?token='.$token.'&email='.$email.'&action=reset" target="_blank">
      http://localhost/LNUstudentdorm/admin/pages/reset-password.php
