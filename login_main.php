      ...
      <div class="row justify-content-center">
        <div class="col-lg-5 col-md-7">
          ...
          <div class="card bg-secondary border-0 mb-0 pt-8">
            ...
            <img src="admin/assets/img/logo.png" class="center-lnu">
              ...
              <strong><big>Students</big></strong>
              </div>
              <?php
       ...
       if(isset($_SESSION['verify'])){
        echo "
          <div class='alert alert-danger alert-dismissible'>
            <button type='button' class='close' data-dismiss='alert' aria-hidden='true'>&times;</button>
            <big><i class='fas fa-exclamation-triangle'></i>&nbsp;&nbsp;".$_SESSION['verify']."</big>
          </div>
        ";
		...
		<div class="form-group mb-3">
                  <div class="input-group input-group-merge input-group-alternative">
                    <div class="input-group-prepend">
                      <span class="input-group-text"><i class="far fa-id-card fa-lg fa-fw"></i></span>
                    </div>
                    <input class="form-control" name = "student" placeholder="Enter Student ID" type = "text" required autofocus>
                  </div>
                </div>
